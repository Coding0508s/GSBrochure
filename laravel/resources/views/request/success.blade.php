...
@section('content')
    <div class="w-full max-w-2xl mx-auto text-center py-12">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ url('requestbrochure-v2') }}" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-primary hover:bg-purple-800 text-white font-medium rounded-lg shadow-sm transition-colors">
                <span class="material-icons text-xl">add_circle_outline</span>
                추가 신청
            </a>
            <a href="{{ url('requestbrochure-list-v2') }}" class="inline-flex items-center justify-center gap-2 px-6 py-3 border-2 border-primary text-primary hover:bg-primary/10 dark:hover:bg-primary/20 font-medium rounded-lg transition-colors">
